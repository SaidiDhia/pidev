...
public class EmailService {
    ...
    private static final String EMAIL_PASSWORD = "nwes wdeh bwet ctsz"; // Utiliser un mot de passe d'application
    ...
    public boolean initialize() {
        try {
            // Initialisation réelle du service email
    ...
    /**
     * Envoie un email de confirmation de réservation avec lien Google Maps
     */
    public boolean sendReservationConfirmation(Reservation reservation) {
        ...
        try {
            ...
            try {
                ...
                // Afficher le contenu dans la console pour débogage
                System.out.println("\n" + "=".repeat(60));
    ...
    /**
     * Génère le contenu HTML de l'email de réservation
     */
    ...
    /**
     * Génère un lien Google Maps pour le lieu de l'événement
     */
    private String generateMapsLink(String location) {
        try {
            ...
            var coords = coordsFuture.get(); // En attente du résultat
            
            if (coords != null) {
                // Générer le lien avec les coordonnées
