...
public class ProductAvailableController {
    ...
    @FXML private void goToCart()              { MainFx.setCenter("/fxml/Cart.fxml"); }
    @FXML private void goToFactureList()       { MainFx.setCenter("/fxml/FactureList.fxml"); }
    @FXML private void goToRoleSelection()     { MainFx.setCenter("/fxml/RoleSelection.fxml"); }
    @FXML private void goToProductManagement() { MainFx.setCenter("/fxml/SellerHome.fxml"); }
